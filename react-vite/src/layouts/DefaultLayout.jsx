    ...
    return (
        <div id="default-layout" className='flex w-full min-h-screen'>
            <aside className='flex flex-col px-8 py-16 bg-green-700'>
                <Link className='py-1 px-2 text-white rounded ease-in-out duration-300 hover:bg-green-600 hover:underline' to="/patents">Patents</Link>
                <Link className='py-1 px-2 text-white rounded ease-in-out duration-300 hover:bg-green-600 hover:underline' to="/settings/notifications">Notifications</Link>
            </aside>
